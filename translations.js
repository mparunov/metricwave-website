...
const translations = {
    ...
    ka: {
        ...
        homeCards: {
            ...
            s1Title: "მონაცემთა ანალიტიკა & BI",
            ...
            s4Title: "AI-ის დანერგვა & ავტომატიზაცია",
        ...
        industries: {
            ...
            techBullet3: "ჯვარედინი-ფუნქციური dashboards და რეპორტინგი",
            aiCoachingTitle: "AI პროდუქტები და ქოუჩინგი",
            aiCoachingTagline: "Analytics და ავტომატიზაცია AI-ნატივი სტარტაპებისთვის და ქოუჩინგ ბიზნესებისთვის, რომლებიც მონაცემებზე მუშაობენ და სკალირებას საჭიროებენ.",
            aiCoachingBullet1: "AI პროდუქტის instrumentation და performance analytics",
            aiCoachingBullet2: "ქოუჩინგ პლატფორმის CRM და workflow ავტომატიზაცია",
            aiCoachingBullet3: "შემოსავლის, შენარჩუნებისა და ზრდის dashboards",
            ...
            nonprofitTagline: "ოპერაციების დიზაინი და გავლენის გაზომვა მისიაზე ორიენტირებული ორგანიზაციებისთვის, რთული stakeholder გარემოთი.",
        ...
        logistics: {
            ...
            sol1Li5: "მორგებული KPI dashboards ოპერაციების მენეჯერებისთვის",
        ...
        technology: {
            ...
            sol3Title: "BI & Executive Reporting",
            sol3Li1: "ჯვარედინი-ფუნქციური dashboards (Tableau, Power BI)",
            ...
            sol3Li5: "მორგებული რეპორტინგის pipelines stakeholder-ის საჭიროებებისთვის",
            clientsTitle: "კლიენტები და ორგანიზაციები",
            client1Title: "Celonis",
        ...
        aiCoaching: {
            ...
            stat4Label: "ინტეგრაციის pipelines აკავშირებს AI ხელსაწყოებს, CRM-ებსა და რეპორტინგის stacks-ებს",
            ...
            sol1Title: "AI პროდუქტის ინტეგრაცია და Analytics",
            sol1Li1: "Event tracking-ის დიზაინი და დანერგვა AI-მძიმე პროდუქტებისთვის",
            sol1Li2: "მოდელის performance dashboards და evaluation pipelines",
            sol1Li3: "მომხმარებლის ქცევის funnels, activation მეტრიკები და feature adoption",
            sol1Li4: "A/B testing ჩარჩოები და ექსპერიმენტის analytics",
            sol1Li5: "მონაცემთა ხარისხის მონიტორინგი AI training-ისა და inference pipelines-ისთვის",
            sol2Title: "ქოუჩინგ პლატფორმის ოპერაციები",
            sol2Li1: "CRM-ის setup და ავტომატიზაცია (HubSpot, GoHighLevel, Notion)",
            sol2Li2: "კლიენტის onboarding workflows და intake ავტომატიზაცია",
            sol2Li3: "სესიის განრიგი, follow-up და renewal trigger flows",
            sol2Li4: "პროგრამის მიწოდების ტრეკინგი და engagement რეპორტინგი",
            sol2Li5: "Testimonial, referral და community engagement სისტემები",
            sol3Title: "შემოსავლის და ზრდის ინფრასტრუქტურა",
            sol3Li1: "შემოსავლის dashboards MRR-ით, churn-ით და LTV-ის ხედვით",
            sol3Li2: "მრავალ-არხიანი attribution და funnel კონვერსიის analytics",
            sol3Li3: "AI-ით დახმარებული lead scoring და pipeline-ის მართვა",
            sol3Li4: "შენარჩუნებისა და upsell trigger-ის ავტომატიზაცია",
            sol3Li5: "ინვესტორებისა და stakeholder-ის რეპორტინგის ჩარჩოები",
            clientsTitle: "კლიენტები და ორგანიზაციები",
            client1Title: "IRAP – International Refugee Assistance Project",
            ...
            client2Title: "Ambitious Impact (AIM)",
            client2Desc: "AIM ამზადებს ეფექტური ალტრუისტებისა და გავლენაზე ორიენტირებული ლიდერების შემდეგ თაობას ინტენსიური ქოუჩინგ პროგრამების მეშვეობით. ჩვენ დავაპროექტეთ მათი კლიენტის ტრეკინგი, intake ავტომატიზაცია და პროგრამის რეპორტინგის სისტემები.",
        ...
        government: {
            ...
            stat3Label: "მაღალი დონის stakeholder engagements კოორდინირებული ერთ პროგრამაში",
            ...
            sol1Li3: "Stakeholder შეხვედრის ხელშეწყობა და ოქმის წერა",
            sol1Li4: "პროგრესის რეპორტინგი და milestone დოკუმენტაცია",
            ...
            sol2Li2: "Stakeholder ინტერვიუები და თვისებრივი კვლევა",
            sol2Li3: "ციფრული უფლებებისა და ტექნოლოგიის პოლიტიკის ანალიზი",
            sol2Li4: "Desk research და ლიტერატურის გადახედვა",
            ...
            client1Desc: "ჩვენ მივაწოდეთ ოპერაციული მხარდაჭერა €3.3M EU-ფინანსირებული კიბერუსაფრთხოების სიმძლავრის ასაშენებელი პროგრამის ტექნიკური ადმინისტრაციისთვის, კოორდინაცია პარტნიორ ორგანიზაციებში, EU დონორებისთვის გრანტის რეპორტინგი და 45+ მაღალი დონის stakeholder engagement-ის ხელშეწყობა.",
            client2Title: "National League of Cities",
            client2Desc: "National League of Cities წარმოადგენს 3,000-ზე მეტი აშშ-ის ქალაქის მუნიციპალურ მთავრობებს. ჩვენ ჩავატარეთ ქალაქის ინოვაციის კვლევა 15+ ქვეყანაში, ჩავატარეთ 50+ stakeholder ინტერვიუ და თანაავტორი გავხდით პოლიტიკის სახელმძღვანელოს, რომელიც გავრცელდა NLC-ის ქალაქი-პარტნიორების სრულ ქსელში.",
            client3Title: "UNDP & NSF",
            ...
            ctaSubtitle: "EU გრანტის რეპორტინგი, მრავალ-stakeholder კოორდინაცია, პოლიტიკის კვლევა — სრული დოკუმენტაციით და audit-მზად შედეგებით.",
        ...
        education: {
            overviewTitle: "რა ვნახეთ ამ სექტორში",
            overviewText: "ჩვენი გუნდის ორივე წევრი არის Notre Dame-ის კურსდამთავრებული. ჩვენ მხარს ვუჭერდით analytics სამუშაოს Notre Dame-ში, McKenna Center for Human Development-ში და NSF-ფინანსირებულ კვლევით პროგრამებში. ეს ნიშნავს, რომ ჩვენ აკადემიურ და კვლევითი-მომიჯნავე სამუშაოს ვუდგებით მეთოდოლოგიური ფრთხილობით და გვესმის რა სჭირდებათ რეალურად ინსტიტუციურ stakeholder-ებს — და არა მხოლოდ რა გამოიყურება კარგად პრეზენტაციაში.",
            stat1Label: "Notre Dame-ის კურსდამთავრებული — MS Business Analytics და ინტერდისციპლინური კვლევა",
            stat2Label: "Analytics მხარდაჭერა NSF-ფინანსირებული კვლევისთვის",
            stat3Label: "სტატისტიკური ხელსაწყო გამოყენებული peer-reviewed კვლევით კონტექსტებში",
            stat4Label: "Stakeholder ინტერვიუ ჩატარებული კვლევითი და პოლიტიკის პროექტებში",
            howWeHelpSubtitle: "კვლევის-ხარისხის analytics და პროგრამის მხარდაჭერა ინსტიტუტებისთვის, სადაც სიმკაცრე არ არის არჩევანი.",
            sol1Title: "კვლევითი Analytics",
            ...
            sol2Li1: "Analytics დოკუმენტაცია გრანტ-ფინანსირებული პროგრამებისთვის",
            ...
            sol2Li5: "Dashboards პროგრამის მონიტორინგისთვის",
            sol3Title: "პროგრამისა და სტრატეგიის მხარდაჭერა",
            sol3Li1: "Stakeholder ინტერვიუს ხელშეწყობა და სინთეზი",
            ...
            ctaTitle: "კვლევის-ხარისხის analytics, აშენებული მათ მიერ, ვინც კვლევა გააკეთეს.",
        ...
        nonprofit: {
            ...
            stat2Label: "Stakeholder ინტერვიუ ჩატარებული კვლევითი და ადვოკატირების პროგრამებში",
            ...
            sol2Li4: "Stakeholder-ის რუკის შედგენა და ექსპერტის ინტერვიუს სინთეზი",
            ...
            sol3Li4: "Stakeholder-ის გამოკითხვები და უკუკავშირის სინთეზი",
        ...
        analyticsBI: {
            ...
            lead: "Dashboards სასარგებლოა მხოლოდ მაშინ, თუ მათ ქვემოთ არსებული მონაცემები სანდოა. ჩვენ ვაშენებთ analytics გარემოს, რომელიც პირდაპირ უკავშირდება თქვენს ოპერაციულ შრეს — ლიდერშიფს აძლევს ერთიან North Star-ს, რომელზეც რეალურად მოქმედებენ ორშაბათ დილით და არა მხოლოდ კვირეულ პრეზენტაციაში გადახედავენ.",
            featuresTitle: "რას ვაშენებთ თქვენთვის",
            feat1: "GA4, Meta Ads და მარკეტინგ-არხის ტრეკინგის setup",
            feat2: "მორგებული BI dashboards (Looker Studio, Metabase, Tableau)",
            feat3: "შემოსავლის, cohort და funnel ანალიზი",
            feat4: "მომხმარებლის სეგმენტაცია და lifetime value-ის მოდელირება",
            ...
            perfectForText: "ოპერაციული და ლიდერშიფ გუნდებისთვის, რომლებმაც დაკარგეს ნდობა მათ dashboards-ში — ან არასოდეს ჰქონდათ ნდობის ღირსი dashboards.",
            resultsTitle: "ტიპიური შედეგები",
            result1: "ერთი სანდო რიცხვი ყოველ გუნდში — აღარასოდეს კონფლიქტური ვერსიები",
            result2: "Dashboards ცოცხლდება დღეებში და არა თვეებში",
        ...
        webDev: {
            ...
            result4: "ყოველი ფორმა, ღილაკი და funnel დატრეკილია პირველი დღიდან",
            stackTitle: "ჩვენი სტეკი",
        ...
        processMining: {
            ...
            feat6: "KPI მონიტორინგის dashboards ოპერაციებისთვის",
            perfectForTitle: "შესაფერისია",
        ...
        automationAI: {
            ...
            result4: "დოკუმენტირებული და auditable: თქვენ ფლობთ ლოგიკას",
            stackTitle: "ჩვენი სტეკი",
    ...
    ru: {
        ...
        industries: {
            ...
            techBullet3: "Кросс-функциональные dashboards и отчётность",
            aiCoachingTitle: "AI-продукты и коучинг",
            aiCoachingTagline: "Analytics и автоматизация для AI-нативных стартапов и коучинг-бизнесов, которые работают на данных и нуждаются в масштабировании.",
            aiCoachingBullet1: "Instrumentation AI-продуктов и performance analytics",
            aiCoachingBullet2: "CRM и workflow-автоматизация для коучинг-платформ",
            aiCoachingBullet3: "Dashboards дохода, удержания и роста",
            ...
            nonprofitTagline: "Дизайн операций и измерение воздействия для миссионально-ориентированных организаций со сложной stakeholder-средой.",
        ...
        logistics: {
            ...
            sol1Title: "Операционная Analytics и Оптимизация",
            ...
            sol1Li5: "Кастомные KPI-dashboards для операционных менеджеров",
        ...
        technology: {
            ...
            sol3Title: "BI & Executive Reporting",
            sol3Li1: "Кросс-функциональные dashboards (Tableau, Power BI)",
            sol3Li2: "Метрики и scorecards для топ-менеджмента",
            sol3Li3: "Продуктовая аналитика и отчётность по использованию features",
            sol3Li4: "Отслеживание performance release и delivery",
            sol3Li5: "Кастомные reporting pipelines под нужды stakeholders",
            clientsTitle: "Клиенты и Организации",
            client1Title: "Celonis",
        ...
        aiCoaching: {
            ...
            sol1Title: "Интеграция и Analytics AI-Продуктов",
            sol1Li1: "Дизайн и внедрение event tracking для AI-powered продуктов",
            sol1Li2: "Dashboards performance моделей и evaluation pipelines",
            sol1Li3: "Funnels поведения пользователей, метрики активации и feature adoption",
            sol1Li4: "Фреймворки A/B testing и аналитика экспериментов",
            sol1Li5: "Мониторинг качества данных для AI training и inference pipelines",
            ...
            sol3Li1: "Dashboards дохода с MRR, churn и LTV-видимостью",
            sol3Li2: "Мульти-канальная атрибуция и аналитика конверсии funnel",
            sol3Li3: "AI-ассистированный lead scoring и управление pipeline",
            sol3Li4: "Автоматизация триггеров удержания и upsell",
            sol3Li5: "Фреймворки отчётности для инвесторов и stakeholders",
            clientsTitle: "Клиенты и Организации",
            client1Title: "IRAP – International Refugee Assistance Project",
            ...
            client2Title: "Ambitious Impact (AIM)",
            client2Desc: "AIM обучает следующее поколение эффективных альтруистов и impact-driven лидеров через интенсивные коучинг-программы. Мы спроектировали их client tracking, автоматизацию intake и системы отчётности программы.",
        ...
        government: {
            ...
            stat3Label: "Engagements высокого уровня со stakeholders координированы в одной программе",
            ...
            sol1Li3: "Фасилитация stakeholder-встреч и ведение протоколов",
            sol1Li4: "Progress-отчётность и документация milestones",
            ...
            sol2Li2: "Интервью со stakeholders и качественное исследование",
            sol2Li3: "Анализ политики в области цифровых прав и технологий",
            sol2Li4: "Desk research и обзор литературы",
            sol2Li5: "Фреймворки AI-политики и governance",
            ...
            client1Desc: "Мы предоставили операционную поддержку для технической администрации €3.3M EU-финансируемой программы по наращиванию потенциала в области кибербезопасности, координируя партнёрские организации, управляя грантовой отчётностью перед EU-донорами и фасилитируя 45+ engagements высокого уровня со stakeholders.",
            client2Title: "National League of Cities",
            client2Desc: "National League of Cities представляет муниципальные правительства более 3,000 городов США. Мы провели исследование городских инноваций в 15+ странах, провели 50+ интервью со stakeholders и стали соавторами политического guidebook, распространённого по полной сети городов-партнёров NLC.",
            client3Title: "UNDP & NSF",
            ...
            ctaSubtitle: "EU-грантовая отчётность, мульти-stakeholder координация, политическое исследование — с полной документацией и audit-готовыми результатами.",
        ...
        education: {
            overviewTitle: "Что Мы Видели в Этом Секторе",
            overviewText: "Оба члена нашей команды — выпускники Notre Dame. Мы поддерживали аналитическую работу в Notre Dame, McKenna Center for Human Development и NSF-финансируемых исследовательских программах. Это значит, что мы подходим к академической и исследовательско-смежной работе с методологической аккуратностью и пониманием того, что действительно нужно институциональным stakeholders — а не только того, что хорошо смотрится в презентации.",
            stat1Label: "Выпускники Notre Dame — MS Business Analytics и междисциплинарное исследование",
            stat2Label: "Analytics-поддержка для NSF-финансируемых исследований",
            stat3Label: "статистических инструментов применено в peer-reviewed исследовательских контекстах",
            stat4Label: "Интервью со stakeholders проведено в исследовательских и политических проектах",
            howWeHelpSubtitle: "Analytics исследовательского качества и программная поддержка для институтов, где строгость не опциональна.",
            sol1Title: "Исследовательская Analytics",
            ...
            sol2Li5: "Dashboards для мониторинга программ",
            sol3Title: "Программная и Стратегическая Поддержка",
            sol3Li1: "Фасилитация и синтез интервью со stakeholders",
            ...
            ctaTitle: "Analytics исследовательского качества, построенная людьми, которые сами проводили исследования.",
            ctaButton: "Поговорить с нашей командой →"
        },
        ...
        nonprofit: {
            ...
            stat2Label: "Интервью со stakeholders проведено в исследовательских и адвокационных программах",
            ...
            sol2Li4: "Картирование stakeholders и синтез экспертных интервью",
            sol2Li5: "Policy briefs и исследовательские публикации",
            ...
            sol3Li4: "Опросы stakeholders и синтез обратной связи",
        ...
        analyticsBI: {
            ...
            lead: "Dashboards полезны, только если данным под ними доверяют. Мы строим analytics-среды, которые подключаются напрямую к Вашему операционному слою — давая руководству единую North Star, на которой они действительно действуют в понедельник утром, а не просто просматривают на еженедельной презентации.",
            featuresTitle: "Что Мы Строим Для Вас",
            feat1: "Настройка GA4, Meta Ads и tracking маркетинговых каналов",
            feat2: "Кастомные BI-dashboards (Looker Studio, Metabase, Tableau)",
            feat3: "Анализ дохода, cohort и funnel",
            feat4: "Сегментация клиентов и моделирование lifetime value",
            feat5: "KPI-фреймворки, согласованные с Вашими целями роста",
            feat6: "Автоматизированные insight-отчёты по Вашему графику",
            perfectForTitle: "Подходит Для",
            perfectForText: "Операционных и руководящих команд, которые потеряли доверие к своим dashboards — или никогда не имели dashboards, заслуживающих доверия.",
            resultsTitle: "Типичные Результаты",
            result1: "Одно доверенное число для каждой команды — больше никаких конфликтующих версий",
            result2: "Dashboards живут за дни, а не за месяцы",
        ...
        webDev: {
            ...
            result4: "Каждая форма, кнопка и funnel отслеживаются с первого дня",
            stackTitle: "Наш стек",
        ...
        processMining: {
            ...
            feat6: "Dashboards KPI-мониторинга для операций",
            perfectForTitle: "Подходит Для",
